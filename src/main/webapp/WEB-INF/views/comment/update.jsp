    ...
    <div class="container mt-5" style="border: 1px solid black; border-radius: 1rem; background-color: rgb(248, 248, 248);">
        ...
        <div>
            <form action="update" method="post" name="updateform">
            	...
            	<label for="">작성자</label>
                <input class="form-control mb-3" type="text" name="c_writer" value="${sessionScope.loginId}" readonly>
                <label for="">내용</label>
                <textarea class="form-control mb-3" name="c_contents">${comment.c_contents}</textarea>
