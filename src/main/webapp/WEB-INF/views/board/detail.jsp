        ...
        <div id="comment-list">
        	...
        	<tr>
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="/comment/delete?b_number=${board.b_number}&page=${page}&c_number=${comment.c_number}">댓글 삭제</a></td>
					<td><a class="btn btn-success" href="/comment/update?b_number=${board.b_number}&page=${page}&c_number=${comment.c_number}">댓글 수정</a></td>
					</c:if>
				</tr>
				</c:forEach>
        	</table>
