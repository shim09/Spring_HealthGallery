...
<body>
  ...
  <a href="/board/catePaging?cate_number=1" type="button" class="btn btn-outline-dark">기타</a>
     ...
     <div style="margin-top: 10%">
	    <form action="/board/cateinsert" method="get" class="btn btn-outline-light row g-3" style="margin-top: 10%">
		<div class="col-auto">
		<input type="text" name="c_name" class="form-control" style="width:300px;" placeholder="등록할 카테고리 입력" style="margin-top: 10px">
		</div><br>
		<div class="col-auto">
