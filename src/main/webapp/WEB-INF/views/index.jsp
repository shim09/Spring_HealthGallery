                    ...
                    <div class="row gx-5 align-items-center justify-content-center">
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h2 class="display-5 fw-bolder text-white mb-2">운동인들을 위한 <br>헬스 갤러리 입니다.</h2>
                                <p class="lead fw-normal text-white-50 mb-4">헬스 갤러리에서 서로의 운동 정보와 팁, 운동 시작 방법 등을 공유하세요!</p>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                   <c:choose>
                             <c:when test="${sessionScope.loginId eq 'SHC'}">
       						<a class="btn btn-outline-light btn-lg px-4" href="/member/findAll">회원목록[관리자]</a>
       						<a class="btn btn-outline-light btn-lg px-4" href="/member/logout">로그아웃</a>
       						</c:when>
                            ...
                            <a class="btn btn-outline-light btn-lg px-4" href="/member/insert">회원가입</a>
                            </c:otherwise>
       						</c:choose>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="${pageContext.request.contextPath}/resources/assets/main.jpg" alt="..." /></div>
                    </div>
                </div>
            </header>
            <!-- Features section-->
